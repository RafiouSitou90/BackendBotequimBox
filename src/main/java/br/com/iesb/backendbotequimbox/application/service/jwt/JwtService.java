package br.com.iesb.backendbotequimbox.application.service.jwt;
...
public class JwtService {
    ...
    @Value(value = "${app.security.jwt.access-expiration}")
    private long jwtAccessExpiration;

    @Value(value = "${app.security.jwt.refresh-expiration}")
